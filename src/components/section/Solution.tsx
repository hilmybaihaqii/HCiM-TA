  ...
  return (
    <section ref={containerRef} id="solution" className="relative w-full bg-background font-sans overflow-hidden">
      ...
      {/* =========================================================
          ...
          ========================================================= */}
      <div className="relative z-10 max-w-7xl mx-auto px-5 md:px-12 pt-28 md:pt-36 pb-16 md:pb-24 border-b border-foreground/10">
      ...
      <div id="model-architecture" className="relative w-full bg-background pt-12 md:pt-16">
        <div className="max-w-7xl mx-auto px-5 md:px-12">
          ...
          <div className="flex flex-col md:flex-row relative" ref={lineRef}>
            ...
            {/* PANEL KIRI: STICKY SIDEBAR (Desktop) / TOP TITLE (Mobile) */}
            ...
            <div className="w-full md:w-2/3 md:pl-16 lg:pl-24 pt-4 md:pt-10 pb-24 md:pb-32 flex flex-col gap-16 md:gap-24">
              ...
              {/* PHASE 01: INGESTION (11 BIOMARKERS) */}
              <motion.div 
              ...
              >
                ...
                {/* Visual Interaktif: Formasi Grid 2-4-5 untuk 11 Biomarker */}
