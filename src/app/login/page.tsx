        ...
        <motion.div variants={containerVariants} initial="hidden" animate="visible" className="w-full max-w-sm flex flex-col">
          ...
          <div className="flex flex-col gap-6 w-full">
            ...
            <motion.div variants={itemVariants} className="flex items-center justify-between mt-2">
              ...
              <Link href="/forgot-password" className="text-[10px] text-white/50 hover:text-accent transition-colors">
                Forgot password?
              </Link>
            </motion.div>
            ...
            <motion.div variants={itemVariants}>
              <button
                ...
                disabled={isLoading}
                className="w-full mt-6 py-4 bg-accent text-white text-xs font-medium uppercase tracking-widest hover:bg-accent-dark hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 rounded-sm disabled:opacity-70 disabled:hover:scale-100 flex items-center justify-center gap-3"
              >
                {isLoading ? (
                  <>
