      ...
      >
        <AnimatePresence mode="wait">
          ...
          {authStatus === 'verifying' && (
            <motion.div key="verifying" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.97 }} className="flex flex-col items-center text-center py-10">
          ...
          {authStatus === 'idle' && (
            <motion.div key="idle" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
              ...
              <form onSubmit={handleSignIn} noValidate className="flex flex-col gap-6 w-full">
